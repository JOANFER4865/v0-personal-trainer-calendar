...
export function ClientDashboard({ userId, userProfile }: ClientDashboardProps) {
      ...
      <header className="border-b bg-white dark:bg-slate-950 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">Bienvenido, {userProfile.full_name}</p>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <Tabs defaultValue="schedule" className="space-y-8">
          ...
          <TabsContent value="schedule" className="space-y-4">
            <AvailabilityViewer clientId={userId} clientProfile={userProfile} />
          </TabsContent>

          <TabsContent value="my-appointments" className="space-y-4">
            <MyAppointments clientId={userId} />
          </TabsContent>
        </Tabs>
      </main>
    </div>
